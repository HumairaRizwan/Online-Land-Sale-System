...
<Body>
<br><br>
<center><h1 class="Ttxtstyle">My Reservations</h1></center>
<section>
	<center>
	<?php
	...
	while ($row = $result->fetch_assoc()) {
		...
		echo"<div id='CareersBody'>
			<div style='display:flex; width:60%; justify-content:space-between; background-color:white;padding:20px 20px;'>
							<div style='margin-top:30px;'><h2>Reservation ID : $RID</h2></div>
							<div style='margin-top:30px;'><h2>Name : $RName</h2></div>";
							
					echo"<div class='btndiv'><a href='ReservationUpdate.php?GetRID=$RID'> <button name='edit' value='Edit' id='' type='button' class='Btn4'>  Edit </button></a><a name='Delete' href='ReservationDelete.php?GetRID=$RID'> <button name='delete' value='Delete' id='' type='button' class='Btn4'>  Delete </button></a>";
					echo"</div>";
			echo"</div>";
		echo"</div>";
		}

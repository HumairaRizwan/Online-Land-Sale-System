...
<Body>
<br><br>
<center><h1 class="Ttxtstyle">News & Events</h1></center><br><br>
<section>
	<div id="NEbody">
		<div class ="card">
			<div id="card-image">
				<img src="../Images/unnamed.png" alt="dansal">
			</div>
				<div id="DArea">
						<h2>The Annual Vesak Maha Dansala 2019</h2>
						
						<p>Lanka Lands organised the Vesak Dansala on the 4th of June 2019 </p>
						<button value="read" id="signing" type="button" class="Btn4" onclick="">Read more</button>
				</div>
			...
			<div class ="card">
				<div id="card-image">
					...
					<div id="DArea">
							...
							<p>Purchase a land for your dream home from urban and sub </p>
							<button value="read" id="signing" type="button" class="Btn4" onclick="">Read more</button>
					</div>
				<div class="card-stats"></div>
			</div>

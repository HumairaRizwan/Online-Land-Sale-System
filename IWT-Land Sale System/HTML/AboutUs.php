 ...
 <title>About Us</title>
   <div>
	<header id="mainHeader">
			...
			<div  class="logo">
				<a href="Home.php">
				<img src="../Images/Logo 2.png" alt="Lanka Lands Logo"><?php echo $_SESSION['CFName']; ?> <?php echo $_SESSION['CLName']; ?>
				</a>
			</div>
			...
			<div style="margin-top:20px; float: right;">
				<a href="UserProfile.php" style="text-decoration: none;"><p style="padding:10px 10px; background: #0073e6;"></p></a>
			</div>

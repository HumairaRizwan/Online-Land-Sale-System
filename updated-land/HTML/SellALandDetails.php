...
<link rel="stylesheet" type="text/css" href="../CSS/sellalandDetails.css">
...
<Body>
<br><br>
<center><h1 class="Ttxtstyle">MY Selling Lands</h1></center>
	<?php
	
	global $con;
	$sql ="SELECT * FROM lands Where CID='$CID'";
	...
	while ($row = $result->fetch_assoc()) {
		...
		echo"<div class ='card'>";
			echo"<div id='card-image'>";
				echo"<img src='../Images/Hills-and-clouds-landscape-vector.jpg' alt=''>";
			echo"</div>";
				echo"<div id='DArea'>";
						echo"<h2>".$row['LName']."</h2>";
						
						echo"<p>".$row['Lmessage']."</p>
				</div>"; 
			echo"<div class='btndiv'><a href='EditSellaLAnd.php?GetLID=$Land_Id'> <button name='edit' value='Edit' id='' type='button' class='Btn4'>  Edit </button></a><a name='Del' href='LandDetailsDelete.php?GetLID=$Land_Id'> <button name='Del' value='Edit' id='' type='button' class='Btn4'>  Delete </button></a>";
				echo"</div>";
		echo"</div>";
